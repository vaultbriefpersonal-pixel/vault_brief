...
export const metadata: Metadata = {
  title: "Terms of Service — Vault Brief",
};
  ...
  return (
    <div style={{ paddingTop: 72 }}>
      <section className="vb-pad-x" style={{ paddingTop: 80, paddingBottom: 120, maxWidth: 720, margin: "0 auto" }}>
        ...
        <p style={s.p}>Vault Brief provides automated investor reporting tools for crypto projects. We connect to your wallet addresses and GitHub organization in read-only mode to generate monthly reports.</p>

        <h2 style={s.h2}>Your account</h2>
        <p style={s.p}>You are responsible for maintaining the security of your account credentials. You agree to provide accurate information and to keep it up to date. You may not share accounts or use Vault Brief on behalf of others without their authorization.</p>
        ...
        <p style={s.p}>Questions? Email <a href="mailto:hello@vaultbrief.io" style={{ color: "var(--accent)", textDecoration: "underline" }}>hello@vaultbrief.io</a>.</p>
      </section>
    </div>
  );
}
