...
export const metadata: Metadata = {
  title: "Privacy Policy — VaultBrief",
};
  ...
  return (
    <div style={{ paddingTop: 72 }}>
      <section className="vb-pad-x" style={{ paddingTop: 80, paddingBottom: 120, maxWidth: 720, margin: "0 auto" }}>
        ...
        <h1 style={{ fontFamily: "var(--font-space-grotesk), 'Space Grotesk', sans-serif", fontSize: "clamp(32px, 4vw, 44px)", fontWeight: 700, color: "#f0f0f0", letterSpacing: "-0.03em", margin: "0 0 40px" }}>Privacy Policy</h1>

        <p style={s.p}>This Privacy Policy explains how VaultBrief ("we", "us", or "our") collects, uses, and shares information about you when you use our services.</p>
        ...
        <p style={s.p}>We use your information to provide and improve the VaultBrief service: generating investor reports, syncing on-chain data, and delivering reports to your investor list.</p>
        ...
        <p style={s.p}>Investor names and email addresses you add to VaultBrief are used solely to deliver reports on your behalf. Investors may request removal from your list at any time by contacting us at hello@vaultbrief.com.</p>
        ...
        <p style={s.p}>Questions about this policy? Email <a href="mailto:hello@vaultbrief.com" style={{ color: "#00e87b", textDecoration: "none" }}>hello@vaultbrief.com</a>.</p>
      </section>
    </div>
  );
}
