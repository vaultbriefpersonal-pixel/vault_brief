...
// GitHub icon removed — the github.com/vaultbrief org doesn't exist
// publicly (real repo is private under vaultbriefpersonal-pixel). A 404
// from the footer reads as broken on a paid product; better no link.
const SOCIALS = [
  {
    label: "X",
